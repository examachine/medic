...
pkgdatadir = $(datadir)/medic
pkglibdir = $(libdir)/medic
pkgincludedir = $(includedir)/medic
...
EXTRA_DIST = medic-id README
SUBDIRS = classgen kernel platform
...
config/config.h.in config/stamp-h.in configure configure.in install-sh \
...
#SUBDIRS = classgen kernel platform doc example-ae

...
#ifndef ExplicitVRLittleEndianBase_Interface
#define ExplicitVRLittleEndianBase_Interface 1

#include "General.hxx"
#include "TransferSyntax.hxx"

// Explicit VR Little Endian Transfer Syntax Base Class
class ExplicitVRLittleEndianBase : public TransferSyntax
{
public:
  ExplicitVRLittleEndianBase() {}
  ...
  // decode a character string of n bytes
  // better improve upon this
  static void encode_string(DStream& d, const string & str, int n) {
